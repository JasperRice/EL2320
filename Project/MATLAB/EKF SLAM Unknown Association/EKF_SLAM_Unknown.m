...
%%%%%%% Load Data %%%%%%%
landmarks = load('map_pent_big_40.txt'); % Load landmark data (only used to plot map and get the number of landmarks)

sensordata = 'so_pb_40_no.txt'; % Load sensor data
